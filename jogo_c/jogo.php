<?php 
    ...
    class JogoMemoria {
        ...
        private function fazerHtmlErros() {
            ...
            if ($this->erros > 7) $this->htmlErros .= "<p w-36>You Lose!</p>";
            if ($this->acertos == sizeof($this->imagens)) $this->htmlErros .= "<p>Victory!</p>";
        }
        ...
        private function fazerHtml() {
            ...
            foreach ($this->cartasJogo as $posicao => $carta) {
                if ($carta->getStatusVirado()) {
                    ...
                    <img class='w-36 h-36 m-1 hover:ring transition'src='img/Cartas.jpg' alt='Cartas.jpg'></button>";
                }
            }
        }
    }